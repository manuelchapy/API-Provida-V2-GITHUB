...
resultadosCtrl.checkDetallesOrdenesExamenes = async(req, res) =>{
                ...
                ///////NIVEL PRUEBAS////////
                    for(let k=0; k<request[i].examenes[j].examen.pruebas.length; k++){
                        ...
                        if(valor == 0){
                            ...
                            await agregarResultadoExtra(request[i].examenes[j].examen.id_detalle_orden, request[i].examenes[j].examen.pruebas[k].id_detalle_examen_prueba);
                        }
                    }
                }
            }
    ...
    async function agregarResultadoExtra(idDetalleOrden, idDetalleExamenPrueba){
        //console.log("ENTRO PARA ACA?")
            return new Promise((resolve, reject) => {
...
resultadosCtrl.checkDetallesOrdenesCultivos = async(req, res) =>{
    //("XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX", req.body)
...
resultadosCtrl.ModificarResultadosExamenes = async(req, res) =>{
    //console.log("-------------------------------------------------------------------------------------", req.body[0].examenes[0].examen.id_usuario)
    ...
    for(let i=0; i<req.body.length; i++){
        ...
        for(let j=0; j<req.body[i].examenes.length; j++){
            ...
            for(let k=0; k<req.body[i].examenes[j].examen.pruebas.length;k++){
                ...
                myValues[c][3]= 1;
                //console.log("///////////////////////////////////////////////////////////////////", req.body[i].examenes[j].examen.id_detalle_orden, req.body[i].examenes[j].examen.pruebas[k].id_detalle_examen_prueba, req.body[i].examenes[j].examen.pruebas[k].resultado,"//////////////////////////////////////////////////////////////////////")
    ...
    async function modificarResultadoMongo(body, paciente, resultado){
        return new Promise((resolve, reject) => {
           // console.log("EEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEE", resultado)
    ...
    async function comentarios(){
        ...
        //console.log("xxxxxxxxxxxxxxxxxxxx", paciente, resultado);
        res.send('1');
    }
...
resultadosCtrl.guardarResultadosExamenes = async(req, res) =>{
    ...
    //console.log(myValues, conteo)
    const sql = 'INSERT INTO tbl_resultado (id_detalle_orden, id_detalle_examen_prueba, resultado) VALUES?';
