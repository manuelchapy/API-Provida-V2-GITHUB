...
administracionFiscalCtrl.cierreDeCajaFiscal = async(req, res) =>{
    ...
    let total_factura_contado =  contadoB + totalBsOrdenesTrabajo;//efectivoBContado + efectivoDContadoAB + efectivoPContadoAB + paypalContadoABolivares + bancolombiaContadoABolivares + zelleContadoABolivares + total_transBancos_factura_contado + total_debitoBancos_factura_contado + total_creditoBancos_factura_contado;
    ...
    ////////////DESCUENTO TOTAL/////////////////
    balance.descuento_total_dolares = Number(Math.round(descuentoD + "e+2") + "e-2");
    balance.descuento_total_bolivares = Number(Math.round(descuentoB + "e+2") + "e-2");
    balance.descuento_total_pesos =  Number(Math.round(descuentoP + "e+2") + "e-2");
    ...
    balance.ganancia_debito_banesco = debitoBanesco;
    balance.ganancia_debito_provincial = debitoProvincial;
    balance.ganancia_debito_mercantil = debitoMercantil;
    balance.ganancia_debito_venezuela = debitoVenezuela;
    balance.ganancia_debito_sofitasa = debitoSofitasa;
    balance.ganancia_debito_100_banco = debito100banco;
    ...
    balance.ganancia_credito_banesco = creditoBanesco;
    balance.ganancia_credito_provincial = creditoProvincial;
    balance.ganancia_credito_mercantil = creditoMercantil;
    balance.ganancia_credito_venezuela = creditoVenezuela;
    balance.ganancia_credito_sofitasa = creditoSofitasa;
    balance.ganancia_credito_100_banco = credito100Banco;
    ...
    balance.ganancia_transferencia_banesco = transBanesco;
    balance.ganancia_transferencia_provincial = transPronvincial;
    balance.ganancia_transferencia_mercantil = transMercantil;
    balance.ganancia_transferencia_venezuela = transVenezuela;
    balance.ganancia_transferencia_sofitasa = transSofitasa;
    balance.ganancia_transferencia_100_banco = trans100Banco;
    ...
    balance.ganancia_transferencia_zelle = zelle;
    balance.ganancia_transferencia_bancolombia = bancolombia;
    balance.ganancia_transferencia_paypal = paypal;
    ////////TOTAL DE GANANCIAS POR TRANSFERENCIAS EN BOLIVARES DE BANCOS NACIONALES FACTURAS AL CONTADO///////////////////
    balance.total_transBancos_factura_contado = total_transBancos_factura_contado;
    ////////TOTAL DE GANANCIAS POR TARJETA DE DEBITO EN BOLIVARES DE BANCOS NACIONALES FACTURAS AL CONTADO///////////////////
    balance.total_debitoBancos_factura_contado = total_debitoBancos_factura_contado;
    ////////TOTAL DE GANANCIAS POR TARJETA DE CREDITO EN BOLIVARES DE BANCOS NACIONALES FACTURAS AL CONTADO///////////////////
    balance.total_creditoBancos_factura_contado = total_creditoBancos_factura_contado;
    ////////TOTAL DE EFECTIVO EN BOLIVARES, PESOS Y DOLARES DE FACTURAS AL CONTADO///////////////////
    balance.efectivo_pesos_factura_contado = efectivoPContado
    balance.efectivo_dolares_factura_contado = efectivoDContado
    balance.efectivo_bolivares_factura_contado = efectivoBContado
    ///////////////////////////TOTAL DE TRANSFERENCIAS EN BANCOLOMBIA ZELLE Y PAYPAL FACTURAS AL CONTADO///////////////////////
    balance.zelle_factura_contado = zelleFacturaContado
    balance.bancolombia_factura_contado = bancolombiaFacturaContado
    balance.paypal_factura_contado = paypalFacturaContado
    ...
    balance.descuento_pesos_factura_contado = descuento_pesos_factura_contado; 
    balance.descuento_dolares_factura_contado = descuento_dolares_factura_contado;
    balance.descuento_bolivares_factura_contado = descuento_bolivares_factura_contado;
    //////////////CANTIDAD DE FACTURAS AL CONTADO///////////////
    balance.cantidad_facturas_contado = cantidad_facturas_contado;
    ...
    balance.descuento_pesos_factura_credito = descuento_pesos_factura_credito; 
    balance.descuento_dolares_factura_credito = descuento_dolares_factura_credito;
    balance.descuento_bolivares_factura_credito = descuento_bolivares_factura_credito;
    ///////////////////CANTIDAD FACTURAS A CREDITO///////////////////////
    balance.cantidad_facturas_credito = cantidad_facturas_credito
    //////////////////SUMATORIA TOTAL DE TRANSFERENCIAS A FACTURAS A CREDITO//////////////////////////////////
    balance.total_transBancos_factura_credito = total_transBancos_factura_credito
    /////////////////SUMATORIA TOTAL EN TARJETAS DE DEBITO A FACTURAS A CREDITO////////////////////////////////
    balance.total_debitoBancos_factura_credito = total_debitoBancos_factura_credito
    ////////TOTAL DE GANANCIAS POR TARJETA DE CREDITO EN BOLIVARES DE BANCOS NACIONALES A FACTURAS A CREDITO////////////////
    balance.total_creditoBancos_factura_credito = total_creditoBancos_factura_credito
    /////////////////TRANSFERENCIA EN BANCOLOMBIA, ZELLE Y PAYPAL EN FACTURAS A CREDITO///////////////////////
    balance.zelleFacturaCredito = zelleFacturaCredito
    balance.bancolombiaFacturaCredito = bancolombiaFacturaCredito
    balance.paypalFacturaCredito = paypalFacturaCredito
    ...
    balance.sumatoria_debito_facturas_credito_contado = sumatoria_debito_facturas_credito_contado
    ///////////////////SUMATORIA DE TARJETAS DE CREDITO Y CREDITO EN FACTURAS AL CONTADO////////////////////////////////////////////
    balance.sumatoria_credito_facturas_credito_contado = sumatoria_credito_facturas_credito_contado
    ////////////SUMA DE CANTIDADES DE FACTURAS A CONTADO Y CREDITO////////
    balance.sumatoria_cantidad_credito_contado = cantidad_facturas_contado + cantidad_facturas_credito
    /////////////FACTURAS ANULADAS////////////////////////////
    ...
    balance.descuento_pesos_factura_anulado = descuento_pesos_factura_anulado, 
    balance.descuento_dolares_factura_anulado = descuento_dolares_factura_anulado, 
    balance.descuento_bolivares_factura_anulado = descuento_bolivares_factura_anulado;
    /////////////////CANTIDAD DE FACTURAS ANULADAS///////////////////////////
    balance.cantidad_facturas_anuladas = cantidad_facturas_anuladas;
    /////////////EFECTIVO RECAUDADO////////////////////////////
    balance.efectivo_dolares = efectivoD,
    balance.efectivo_pesos = efectivoP,
    balance.efectivo_bolivares = efectivoB
    ///////////////////SUMATORIA TOTAL DE TARJETAS DE DEBITO Y CREDITO Y TRANSFERENCIAS DE BANCOS NACIONALES///////////////////////////
    balance.sumatoria_total_provincial = sumatoria_total_provincial
    balance.sumatoria_total_sofitasa = sumatoria_total_sofitasa
    balance.sumatoria_total_mercantil = sumatoria_total_mercantil
    balance.sumatoria_total_banesco = sumatoria_total_banesco
    balance.sumatoria_total_venezuela = sumatoria_total_venezuela
    balance.sumatoria_total_100_banco = sumatoria_total_100_banco
    /////////////ABONOS HECHOS EN LA FECHA/////////////////////
    balance.abonos_dolares = abonadoD
    balance.abonos_pesos = abonadoP
    balance.abonos_bolivares = abonadoB
...
//////////////SECCION DE IGTF///////////////////////
    //////////////////SUMATORIA DE IGTF TOTALES/////////////////////////////
    balance.IGTF_bolivares_transferencia = igtfBTransferencia,
    balance.IGTF_pesos_transferencia = igtfPTransferencia,
    balance.IGTF_dolares_transferencia = igtfDTransferencia,
    balance.IGTF_bolivares_tarjeta_credito = igtfBEfectivo,
    balance.IGTF_pesos_tarjeta_credito = igtfPCredito
    balance.IGTF_dolares_tarjeta_credito = igtfDCredito
    ...
    balance.IGTF_bolivares_efectivo = igtfBEfectivo,
    balance.IGTF_pesos_efectivo = igtfPEfectivo, 
    balance.IGTF_dolares_efectivo = igtfDEfectivo, 
    balance.IGTF_bolivares_tarjeta_debito = igtfBDebito
    balance.IGTF_pesos_tarjeta_debito = igtfPDebito, 
    balance.IGTF_dolares_factura_debito = igtfDDebito
    ///////////////////////////////////////////////////////////////////////
    /////////////////SUMATORIA DE IGTF POR FACTURAS A CREDITO////////////////////////////////
    balance.IGTF_bolivares_transferencia_factura_credito = igtfBTransferenciaFacturaCredito,
    balance.IGTF_pesos_transferencia_factura_credito = igtfPTransferenciaFacturaCredito,
    balance.IGTF_dolares_transferencia_factura_credito = igtfDTransferenciaFacturaCredito,
    balance.IGTF_bolivares_tarjeta_credito_factura_credito = igtfBEfectivoFacturaCredito,
    balance.IGTF_pesos_tarjeta_credito_factura_credito = igtfPCreditoFacturaCredito
    balance.IGTF_dolares_tarjeta_credito_factura_credito = Number(Math.round(igtfDCreditoFacturaCredito + "e+2") + "e-2"),
    balance.IGTF_bolivares_factura_credito = Number(Math.round(igtfBFacturaCredito + "e+2") + "e-2"),
    ...
    balance.IGTF_bolivares_efectivo_factura_credito = igtfBEfectivoFacturaCredito,
    balance.IGTF_pesos_efectivo_factura_credito = igtfPEfectivoFacturaCredito, 
    balance.IGTF_dolares_efectivo_factura_credito = igtfDEfectivoFacturaCredito, 
    balance.IGTF_bolivares_tarjeta_debito_factura_credito = igtfBDebitoFacturaCredito
    balance.IGTF_pesos_tarjeta_debito_factura_credito = igtfPDebitoFacturaCredito, 
    balance.IGTF_dolares_factura_debito_factura_credito = igtfDDebitoFacturaCredito
    /////////////////////////////////////////////////////////////////////////////////////////
    /////////////////SUMATORIA DE IGTF POR FACTURAS A CONTADO////////////////////////////////
    balance.IGTF_bolivares_transferencia_factura_contado = igtfBTransferenciaFacturaContado,
    balance.IGTF_pesos_transferencia_factura_contado = igtfPTransferenciaFacturaContado,
    balance.IGTF_dolares_transferencia_factura_contado = igtfDTransferenciaFacturaContado,
    balance.IGTF_bolivares_tarjeta_credito_factura_contado = igtfBEfectivoFacturaCredito,
    balance.IGTF_pesos_tarjeta_credito_factura_contado = igtfPCreditoFacturaContado
    balance.IGTF_dolares_tarjeta_credito_factura_contado = igtfDCreditoFacturaContado
    ...
    balance.IGTF_pesos_efectivo_factura_contado = igtfPEfectivoFacturaContado, 
    balance.IGTF_dolares_efectivo_factura_contado = igtfDEfectivoFacturaContado, 
    balance.IGTF_bolivares_tarjeta_debito_factura_contado = igtfBDebitoFacturaContado
    balance.IGTF_pesos_tarjeta_debito_factura_contado = igtfPDebitoFacturaContado, 
    balance.IGTF_dolares_factura_debito_factura_contado = igtfDDebitoFacturaContado
    /////////////////////////////////////////////////////////////////////////////////////////
    ...
    balance.IGTF_total_bolivares_transferencia = igtfBTransferenciaFacturaContado + igtfBTransferenciaFacturaCredito
    balance.IGTF_total_pesos_transferencia = igtfPTransferenciaFacturaContado + igtfPTransferenciaFacturaCredito
    balance.IGTF_total_dolares_transferencia = igtfDTransferenciaFacturaContado + igtfDTransferenciaFacturaCredito
    balance.IGTF_total_bolivares_tarjetas_credito = igtfBCreditoFacturaContado + igtfBCreditoFacturaCredito
    balance.IGTF_total_pesos_tarjetas_credito = igtfPCreditoFacturaContado + igtfPCreditoFacturaCredito
    balance.IGTF_total_dolares_tarjetas_credito = igtfDCreditoFacturaContado + igtfDCreditoFacturaCredito
    balance.IGTF_total_bolivares_tarjetas_debito = igtfBDebitoFacturaContado + igtfBDebitoFacturaCredito
    balance.IGTF_total_pesos_tarjetas_debito = igtfPDebitoFacturaContado + igtfPDebitoFacturaCredito
    balance.IGTF_total_dolares_tarjetas_debito = igtfDDebitoFacturaContado + igtfDDebitoFacturaCredito

    ////////////////////////////SECCION DE RECIBOS/////////////////////////////////
    ////////////////////////////SUMATORIA DE DIVISAS GENERAL DE RECIBOS////////////////////////
    /////////////SUMATORIA DE REGISTROS CONVENIOS////////////////////
    balance.total_recibos_bolivares_registro_convenio = totalBolivaresReciboRegistroConvenio, 
    balance.total_recibos_pesos_registro_convenio = totalPesosReciboRegistroConvenio, 
    balance.total_recibos_dolares_registro_convenio = totalDolaresReciboRegistroConvenio;
    ////////////SUMATORIA DE FACTURAS A CREDITO//////////////////////
    balance.total_recibos_bolivares_facturas_credito = totalBolivaresReciboFacturasCredito, 
    balance.total_recibos_pesos_facturas_credito = totalPesosReciboFacturasCredito, 
    balance.total_recibos_dolares_facturas_credito = totalDolaresReciboFacturasCredito;
    /////////////////////NOTAS A CREDITO/////////////////////////////
    ...
    async function buscarRegistrosPago(item, registroPago) {
        return new Promise((resolve, reject) => {
            let sql = "SELECT tbl_registro_pago.id_registro_pago, CAST(tbl_registro_pago.tipo_registro AS INT) AS tipo_registro, DATE_FORMAT(tbl_registro_pago.fecha_creacion, '%d-%m-%Y %T') AS fecha_creacion, tbl_registro_pago.id_factura, tbl_registro_pago.id_nota_credito, tbl_registro_pago.id_nota_debito, tbl_registro_pago.id_recibo, tbl_registro_pago.id_registro_divisa, tbl_registro_pago.id_tipo_pago, tbl_registro_pago.id_banco, tbl_registro_pago.numero_referencia, tbl_registro_pago.monto, tbl_tipo_pago.tipo_pago_nombre, tbl_banco.banco_nombre, tbl_registro_divisa.id_divisa, CAST(tbl_registro_pago.igtf_pago AS INT) AS igtf_pago, tbl_divisa.divisa_nombre FROM tbl_registro_pago INNER JOIN tbl_tipo_pago ON tbl_tipo_pago.id_tipo_pago = tbl_registro_pago.id_tipo_pago LEFT JOIN tbl_banco ON tbl_banco.id_banco = tbl_registro_pago.id_banco INNER JOIN tbl_registro_divisa ON tbl_registro_pago.id_registro_divisa = tbl_registro_divisa.id_registro_divisa INNER JOIN tbl_divisa ON tbl_divisa.id_divisa = tbl_registro_divisa.id_divisa WHERE tbl_registro_pago.id_factura='" + item.id_factura + "' AND (tbl_registro_pago.fecha_creacion BETWEEN '"+req.body.from+"' AND '"+req.body.to+"')";
            connection.query(sql, function (err, result, fields) {
                if (err) {
                    console.log('ERROR en CheckTemplate', err);
                    res.send('3');
    ...
    async function buscarRegistrosPagoRecibo(item, registroPago) {
        return new Promise((resolve, reject) => {
            let sql = "SELECT tbl_registro_pago.id_registro_pago, DATE_FORMAT(tbl_registro_pago.fecha_creacion, '%d-%m-%Y %T') AS fecha_creacion, tbl_registro_pago.id_factura, tbl_registro_pago.id_nota_credito, tbl_registro_pago.id_nota_debito, tbl_registro_pago.id_recibo, tbl_registro_pago.id_registro_divisa, tbl_registro_pago.id_tipo_pago, tbl_registro_pago.id_banco, tbl_registro_pago.numero_referencia, tbl_registro_pago.monto, tbl_tipo_pago.tipo_pago_nombre, tbl_banco.banco_nombre, tbl_registro_divisa.id_divisa, tbl_divisa.divisa_nombre FROM tbl_registro_pago INNER JOIN tbl_tipo_pago ON tbl_tipo_pago.id_tipo_pago = tbl_registro_pago.id_tipo_pago LEFT JOIN tbl_banco ON tbl_banco.id_banco = tbl_registro_pago.id_banco INNER JOIN tbl_registro_divisa ON tbl_registro_pago.id_registro_divisa = tbl_registro_divisa.id_registro_divisa INNER JOIN tbl_divisa ON tbl_divisa.id_divisa = tbl_registro_divisa.id_divisa WHERE tbl_registro_pago.id_recibo='" + item.id_recibo + "' AND (tbl_registro_pago.fecha_creacion BETWEEN '"+req.body.from+"' AND '"+req.body.to+"')";
            connection.query(sql, function (err, result, fields) {
                if (err) {
                    console.log('ERROR en CheckTemplate', err);
                    res.send('3');
...
administracionFiscalCtrl.cierreDeCajaNoFiscal = async(req, res) =>{
    ...
    let i = 0;
    let balance = {};
    let efectivoD = 0, efectivoP = 0, efectivoB = 0, zelle = 0, paypal = 0, bancolombia = 0, contadoB = 0, contadoP = 0, contadoD = 0, creditoB = 0, creditoP =0, creditoD = 0, anuladoB = 0, anuladoP = 0, anuladoD = 0, NC = 0, transferencia = 0;
    let provincial = 0, transPronvincial = 0, sofitasa = 0, transSofitasa = 0, mercantil = 0, transMercantil = 0, banesco = 0, transBanesco = 0, venezuela = 0, transVenezuela = 0;
    let debitoProvincial = 0, creditoProvincial = 0, creditoSofitasa = 0, debitoSofitasa = 0, creditoMercantil = 0, debitoMercantil = 0, creditoBanesco = 0, debitoBanesco = 0, debitoVenezuela = 0, creditoVenezuela = 0;
    let ttProvincial = 0, ttSofitasa = 0, ttMercantil = 0, ttBanesco = 0;
    let descuentoP = 0, descuentoB = 0, descuentoD = 0;
    let abonadoD = 0, abonadoP = 0, abonadoB = 0;
    let facturaPRI, facturaULT;
    let detallesAnuladas = [];
    ...
    ///////////////////////////////////////////////SEGUNDO RECUADRO FALTANTE///////////////////////////////////////////
    let total_transBancos_factura_contado = 0, transBanesco_factura_contado = 0, transProvincial_factura_contado = 0, transSofitasa_factura_contado = 0, transMercantil_factura_contado = 0, transVenezuela_factura_contado = 0, bancolombiaFacturaContado = 0, paypalFacturaContado = 0, zelleFacturaContado = 0;
    let total_debitoBancos_factura_contado = 0, debitoBanescoContado = 0, debitoProvincialContado = 0, debitoMercantilContado = 0, debitoVenezuelaContado = 0, debitoSofitasaContado = 0;
    let total_creditoBancos_factura_contado = 0, creditoBanescoContado = 0, creditoProvincialContado = 0, creditoMercantilContado = 0, creditoVenezuelaContado = 0, creditoSofitasaContado = 0;
    let efectivoPContado = 0, efectivoBContado = 0, efectivoDContado = 0;

    /////////////////////////////////////////////////TERCER RECUADRO///////////////////////////////////////////////////
    let total_transBancos_factura_credito = 0, transBanesco_factura_credito = 0, transProvincial_factura_credito = 0, transSofitasa_factura_credito = 0, transMercantil_factura_credito = 0, transVenezuela_factura_credito = 0, bancolombiaFacturaCredito = 0, paypalFacturaCredito = 0, zelleFacturaCredito = 0;
    let total_debitoBancos_factura_credito = 0, debitoBanescoCredito = 0, debitoProvincialCredito = 0, debitoMercantilCredito = 0, debitoVenezuelaCredito = 0, debitoSofitasaCredito = 0;
    let total_creditoBancos_factura_credito = 0, creditoBanescoCredito = 0, creditoProvincialCredito = 0, creditoMercantilCredito = 0, creditoVenezuelaCredito = 0, creditoSofitasaCredito = 0;
    let efectivoPCredito = 0, efectivoBCredito = 0, efectivoDCredito = 0;
    ...
    for(const item of facturas){
        ...
        //////////////////////////////FACTURAS AL CONTADO////////////////////////
        if(item.id_tipo_factura == 1){
            cantidad_facturas_contado ++;
            contadoB = contadoB + item.total_bolivares
            contadoD = contadoD + item.total_dolares
            contadoP = contadoP + item.total_pesos
            /////////////////////////////DESCUENTOS EN FACTURAS A CONTADO///////////////////////////
            descuento_pesos_factura_contado = descuento_pesos_factura_contado + item.descuento_pesos, 
            descuento_dolares_factura_contado = descuento_dolares_factura_contado + item.descuento_dolares, 
            descuento_bolivares_factura_contado = descuento_bolivares_factura_contado + item.descuento_bolivares
            for(const pago of item.registro_pagos){
                ...
                ///////////////////////////INGRESO POR EFECTIVO FACTURAS A CONTADO////////////////////////////////
                if(pago.id_tipo_pago == 2 && pago.igtf_pago == 0 && pago.tipo_registro == 0){
                    ///////EFECTIVO PESOS//////
                    if(pago.id_divisa == 1){
                        efectivoPContado = efectivoPContado + pago.monto
                    }else if(pago.id_divisa == 2){
        ...
        //////////////////////SUMATORIAS DE FACTURAS CREDITO Y CONTADO///////////////////////////
        monto_total_facturas_pesos = contadoP + creditoP, 
        monto_total_facturas_dolares = contadoD + creditoD, 
        monto_total_facturas_bolivares = contadoB + creditoB
        //////////////////////////FACTURAS ANULADAS/////////////////////////////
        if(item.id_estado_factura == 3){
            cantidad_facturas_anuladas++;
            anuladoB = anuladoB + item.total_bolivares
            anuladoD = anuladoD + item.total_dolares
            anuladoP = anuladoP + item.total_pesos
            detallesAnuladas.push({
                numero_factura: item.numero_factura,
                cliente: item.cliente_nombre +" "+item.cliente_apellido,
                motivo: item.anulacion_motivo
    ...
    //////////////////////////SUMATORIAS TOTALES EN FACTURAS A CONTADO///////////////////////////////////////
    total_transBancos_factura_contado = transBanesco_factura_contado + transProvincial_factura_contado + transMercantil_factura_contado + transVenezuela_factura_contado + transSofitasa_factura_contado;
    total_debitoBancos_factura_contado = debitoBanescoContado + debitoProvincialContado + debitoMercantilContado + debitoVenezuelaContado + debitoSofitasaContado;
    total_creditoBancos_factura_contado = creditoBanescoContado + creditoProvincialContado + creditoMercantilContado + creditoVenezuelaContado + creditoSofitasaContado;
    /////CONVERSIONES FACTURAS A CONTADO/////
    const efectivoDContadoAB = efectivoDContado * bolivares;
    const efectivoPContadoAB = (efectivoPContado / pesos) * bolivares;
    const paypalContadoABolivares = paypalFacturaContado * bolivares;
    const bancolombiaContadoABolivares = (bancolombiaFacturaContado / pesos) * bolivares;
    const zelleContadoABolivares = zelleFacturaContado * bolivares;
    let total_factura_contado =  efectivoBContado + efectivoDContadoAB + efectivoPContadoAB + paypalContadoABolivares + bancolombiaContadoABolivares + zelleContadoABolivares + total_transBancos_factura_contado + total_debitoBancos_factura_contado + total_creditoBancos_factura_contado;
    if(isNaN(total_factura_contado)){
        total_factura_contado = 0;
    }
    //////////////////////////SUMATORIAS TOTALES EN FACTURAS A CREDITO///////////////////////////////////////
    total_transBancos_factura_credito = transBanesco_factura_credito + transProvincial_factura_credito + transMercantil_factura_credito + transVenezuela_factura_credito + transSofitasa_factura_credito;
    total_debitoBancos_factura_credito = debitoBanescoCredito + debitoProvincialCredito + debitoMercantilCredito + debitoVenezuelaCredito + debitoSofitasaCredito;
    total_creditoBancos_factura_credito = creditoBanescoCredito + creditoProvincialCredito + creditoMercantilCredito + creditoVenezuelaCredito + creditoSofitasaCredito;
    /////CONVERSIONES FACTURAS A CONTADO/////
    const efectivoDCreditoAB = efectivoDCredito * bolivares;
    const efectivoPCreditoAB = (efectivoPCredito / pesos) * bolivares;
    const paypalCreditoABolivares = paypalFacturaCredito * bolivares;
    const bancolombiaCreditoABolivares = (bancolombiaFacturaCredito / pesos) * bolivares;
    const zelleCreditoABolivares = zelleFacturaCredito * bolivares;
    let total_factura_credito =  efectivoBCredito + efectivoDCreditoAB + efectivoPCreditoAB + paypalCreditoABolivares + bancolombiaCreditoABolivares + zelleCreditoABolivares + total_transBancos_factura_credito + total_debitoBancos_factura_credito + total_creditoBancos_factura_credito;
    if(isNaN(total_factura_credito)){
        total_factura_credito = 0;
    }
    //////////////////////////////////SUMATORIAS DE RECUADRO CUATRO//////////////////////////////////////////
    ...
    //////////////////////////////////SUMATORIAS DE RECUADRO QUINTO//////////////////////////////////////////
    const sumatoria_total_provincial = transPronvincial + debitoProvincial + creditoProvincial;
    const sumatoria_total_sofitasa = transSofitasa + debitoSofitasa + creditoSofitasa;
    const sumatoria_total_mercantil = transMercantil + debitoMercantil + creditoMercantil;
    const sumatoria_total_banesco = transBanesco + debitoBanesco + creditoBanesco;
    const sumatoria_total_venezuela = transVenezuela + debitoVenezuela + creditoVenezuela;
    ...
    balance.ganancia_debito_venezuela = debitoVenezuela;
    balance.ganancia_debito_sofitasa = debitoSofitasa;
    balance.total_tarjeta_debito_bancos_nacionales = debitoBanesco + debitoProvincial + debitoMercantil + debitoVenezuela + debitoSofitasa
    //////////GANANCIA TARJETAS DE CREDITO NACIONALES////////
    balance.ganancia_credito_banesco = creditoBanesco;
    balance.ganancia_credito_provincial = creditoProvincial;
    balance.ganancia_credito_mercantil = creditoMercantil;
    balance.ganancia_credito_venezuela = creditoVenezuela;
    balance.ganancia_credito_sofitasa = creditoSofitasa;
    balance.total_tarjeta_credito_bancos_nacionales = creditoBanesco + creditoProvincial + creditoMercantil + creditoVenezuela + creditoSofitasa
    /////////GANANCIA TRANSFERENCIAS NACIONALES//////////////
    balance.ganancia_transferencia_banesco = transBanesco;
    balance.ganancia_transferencia_provincial = transPronvincial;
    balance.ganancia_transferencia_mercantil = transMercantil;
    balance.ganancia_transferencia_venezuela = transVenezuela;
    balance.ganancia_transferencia_sofitasa = transSofitasa;
    balance.total_transferencias_bancos_nacionales = transBanesco + transPronvincial + transMercantil + transVenezuela + transSofitasa;
    /////////GANANCIA TRANSFERENCIAS INTERNACIONALES//////////////
    balance.ganancia_transferencia_zelle = zelle;
    balance.ganancia_transferencia_bancolombia = bancolombia;
    balance.ganancia_transferencia_paypal = paypal;
    ...
    balance.cantidad_facturas_contado = cantidad_facturas_contado;
    /////////////SUMA TOTAL DE GANANCIAS DE FACTURAS AL CONTADO///////////////////////
    balance.total_factura_contado = total_factura_contado
    /////////////INGRESOS POR FACTURAS A CREDITO////////////////
    balance.ganancia_factura_credito_bolivares = Number(Math.round(creditoB + "e+2") + "e-2");;
    balance.ganancia_factura_credito_dolares = Number(Math.round(creditoD + "e+2") + "e-2");
    balance.ganancia_factura_credito_pesos = Number(Math.round(creditoP + "e+2") + "e-2");
    ...
    balance.paypalFacturaCredito = paypalFacturaCredito
    /////////////SUMA TOTAL DE GANANCIAS DE FACTURAS A CREDITO///////////////////////
    balance.total_factura_credito = total_factura_credito
    /////////////SUMA DE FACTURAS A CREDITO Y CONTADO////////////////
    balance.monto_total_facturas_pesos = Number(Math.round(monto_total_facturas_pesos + "e+2") + "e-2")
    balance.monto_total_facturas_dolares = Number(Math.round(monto_total_facturas_dolares + "e+2") + "e-2")
    balance.monto_total_facturas_bolivares = Number(Math.round(monto_total_facturas_bolivares + "e+2") + "e-2")
...
administracionFiscalCtrl.cierreDeCajaConsolidado = async(req, res) =>{
    ...
    //console.log("***********", recibos)
    abonosOutRango = await buscarRegistrosPagoOutRango(facturas[0].id_factura, facturas[facturas.length - 1].id_factura)
    ...
    total_creditoBancos_factura_credito = Number(Math.round((creditoBanescoCredito + creditoProvincialCredito + creditoMercantilCredito + creditoVenezuelaCredito + creditoSofitasaCredito + credito100BancoCredito) + "e+2") + "e-2");
    /////CONVERSIONES FACTURAS A CONTADO/////
    efectivoDCredito = Number(Math.round((efectivoDCredito) + "e+2") + "e-2");
    efectivoPCredito = Number(Math.round((efectivoPCredito) + "e+2") + "e-2");
    efectivoBContado = Number(Math.round((efectivoBCredito) + "e+2") + "e-2");
    balance.abono_dolares_efectivo = efectivoDCredito,
    balance.abono_pesos_efectivo = efectivoPCredito,
    balance.abono_bolivares_efectivo = efectivoBCredito;
    //balance.abono_paypal = 
    let total_factura_credito = creditoB;//efectivoBCredito + efectivoDCreditoAB + efectivoPCreditoAB + paypalCreditoABolivares + bancolombiaCreditoABolivares + zelleCreditoABolivares + total_transBancos_factura_credito + total_debitoBancos_factura_credito + total_creditoBancos_factura_credito + 0;
    if(isNaN(total_factura_credito)){
        total_factura_credito = 0;
    }
    ...
    balance.ganancia_transferencia_bancolombia = Number(Math.round((bancolombia) + "e+2") + "e-2");
    ...
    balance.bancolombia_factura_contado = Number(Math.round((bancolombiaFacturaContado + igtfPTransferencia) + "e+2") + "e-2");
    ...
    balance.total_factura_contado = Number(Math.round(total_factura_contado + "e+2") + "e-2");
    /////////////INGRESOS POR FACTURAS A CREDITO////////////////
    balance.ganancia_factura_credito_bolivares = Number(Math.round((creditoB + igtfBCreditoFacturaContado) + "e+2") + "e-2");
    balance.ganancia_factura_credito_dolares = Number(Math.round(creditoD + "e+2") + "e-2");
    balance.ganancia_factura_credito_pesos = Number(Math.round(creditoP + "e+2") + "e-2");
    ////////////DESCUENTO POR FACTURAS A CREDITO/////////////////
    ...
    balance.cantidad_facturas_anuladas = cantidad_facturas_anuladas;
    /////////////EFECTIVO RECAUDADO////////////////////////////
    balance.efectivo_dolares = Number(Math.round(efectivoD + "e+2") + "e-2");
    balance.efectivo_pesos = Number(Math.round(efectivoP + "e+2") + "e-2");
    balance.efectivo_bolivares = Number(Math.round(efectivoB + "e+2") + "e-2");
    ///////////////////SUMATORIA TOTAL DE TARJETAS DE DEBITO Y CREDITO Y TRANSFERENCIAS DE BANCOS NACIONALES///////////////////////////
...
//////////////SECCION DE IGTF///////////////////////
    ...
    balance.IGTF_bolivares_tarjeta_debito = Number(Math.round(igtfBDebito) + "e-2");
    ...
    async function buscarRegistrosPagoOutRango(primerId, ultimoId) {
        return new Promise((resolve, reject) => {
            let sql = "SELECT tbl_registro_pago.id_registro_pago, CAST(tbl_registro_pago.tipo_registro AS INT) AS tipo_registro, DATE_FORMAT(tbl_registro_pago.fecha_creacion, '%d-%m-%Y %T') AS fecha_creacion, tbl_registro_pago.id_factura, tbl_registro_pago.id_nota_credito, tbl_registro_pago.id_nota_debito, tbl_registro_pago.id_recibo, tbl_registro_pago.id_registro_divisa, tbl_registro_pago.id_tipo_pago, tbl_registro_pago.id_banco, tbl_registro_pago.numero_referencia, tbl_registro_pago.monto, tbl_tipo_pago.tipo_pago_nombre, tbl_banco.banco_nombre, tbl_registro_divisa.id_divisa, CAST(tbl_registro_pago.igtf_pago AS INT) AS igtf_pago, tbl_divisa.divisa_nombre FROM tbl_registro_pago INNER JOIN tbl_tipo_pago ON tbl_tipo_pago.id_tipo_pago = tbl_registro_pago.id_tipo_pago LEFT JOIN tbl_banco ON tbl_banco.id_banco = tbl_registro_pago.id_banco INNER JOIN tbl_registro_divisa ON tbl_registro_pago.id_registro_divisa = tbl_registro_divisa.id_registro_divisa INNER JOIN tbl_divisa ON tbl_divisa.id_divisa = tbl_registro_divisa.id_divisa WHERE (tbl_registro_pago.id_factura NOT BETWEEN '"+primerId+"' AND '"+ultimoId+"') AND (tbl_registro_pago.fecha_creacion BETWEEN '"+req.body.from+"' AND '"+req.body.to+"')";
            connection.query(sql, function (err, result, fields) {
                if (err) {
                    console.log('ERROR en CheckTemplate', err);
                    res.send('3');
...
administracionFiscalCtrl.reporteDeVentasConsolidado = async(req, res) =>{
    ...
    /////FACTURAS/////
    sql = "SELECT tbl_factura.id_factura, tbl_factura.numero_factura, tbl_factura.orden_trabajo, tbl_factura.debe_dolares, tbl_factura.total_bolivares, tbl_factura.total_dolares, tbl_factura.total_pesos, tbl_factura.id_usuario, tbl_factura.id_cliente, tbl_factura.id_tipo_factura, tbl_factura.id_estado_factura, DATE_FORMAT(tbl_factura.fecha_creacion_factura, '%y-%m-%d') AS fecha_creacion_factura, DATE_FORMAT(tbl_factura.fecha_cancelacion, '%y-%m-%d') AS fecha_cencelacion_factura, tbl_factura.id_estado_factura, tbl_factura.descuento_bolivares, tbl_factura.descuento_dolares, tbl_factura.descuento_pesos, tbl_factura.anulacion_motivo, tbl_factura.IGTF_dolares, tbl_factura.IGTF_pesos, tbl_factura.IGTF_bolivares, tbl_factura.base_imponible_bolivares, tbl_factura.base_imponible_dolares, tbl_tipo_factura.tipo_factura_nombre, tbl_cliente.cliente_nombre, tbl_cliente.cliente_apellido, tbl_cliente.cedula_RIF FROM `tbl_factura` LEFT JOIN tbl_tipo_factura ON tbl_tipo_factura.id_tipo_factura = tbl_factura.id_tipo_factura LEFT JOIN tbl_cliente ON tbl_cliente.id_cliente = tbl_factura.id_cliente WHERE (fecha_creacion_factura BETWEEN '"+req.body.from+"' AND '"+req.body.to+"') AND tbl_factura.orden_trabajo IS NULL AND tbl_factura.id_estado_factura != 3 ORDER BY id_factura ASC";
