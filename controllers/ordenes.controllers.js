...
ordenesCtrl.ordenes = async (req, res) => {
    ...
    if (req.body.tipoBusqueda == 1) {
        ///////##############################################POR NUMERO DE ORDEN#####################################//////////////
           ...
           for(const item of ordenes){
            ...
            async function buscarOrdenes(ordenes){
                ...
                return new Promise((resolve, reject) => {
                    sql = "SELECT id_orden, numero_orden, orden_qr, DATE_FORMAT(fecha, '%d-%m-%Y') AS fecha, anulado FROM `tbl_orden` WHERE numero_orden = '" + busqueda + "' AND (fecha BETWEEN '" + req.body.from + "' AND '"+req.body.to+"')";
                    connection.query(sql, function (err, result, fields) {
                    if (err) {
                        console.log('ERROR en CheckTemplate', err);
                        res.send('3');
                        ...
                        if (result) {
                            ...
                            if(result[0].id_factura === 'undefined' || result[0].id_factura == null){
                                ...
                                detalleFacturaPaciente.push({
                                    ...
                                    paciente_edad: result[0].edad,
                                    numero_orden: idDetalleFacturaPaciente.numero_orden,
                                    aulado: idDetalleFacturaPaciente.anulado,
                                    orden_qr: idDetalleFacturaPaciente.orden_qr,
                                    fecha_orden: idDetalleFacturaPaciente.fecha
                                })
                            }
        ...
        for(const item of facturasRegistroConveniosOrdenes){
           bool = moment(item.fecha_orden).isBetween(req.body.from, req.body.to, 'days', '[]')
           if(bool == true){
        ...
        async function buscarOrdenYFiltrar(detalleFacturaPaciente, detallesFacturaOrden){
            return new Promise((resolve, reject) => {
                let sql = "SELECT tbl_detalle_orden.id_orden, tbl_orden.anulado, tbl_orden.numero_orden, tbl_orden.orden_qr, DATE_FORMAT(tbl_orden.fecha, '%Y-%m-%d') AS fecha_orden FROM tbl_detalle_orden INNER JOIN tbl_orden ON tbl_orden.id_orden = tbl_detalle_orden.id_orden WHERE tbl_detalle_orden.id_detalle_factura_paciente = '" +detalleFacturaPaciente.id_detalle_factura_paciente +"'";
                connection.query(sql, function (err, result, fields) {
                    if (err) {
                        console.log('ERROR en CheckTemplate', err);
                        res.send('3');
                    ...
                    if (result) {
                        let bool = moment(result[0].fecha_orden).isBetween(req.body.from, req.body.to, 'days', '[]')
                        if(bool == true){
        ...
        async function buscarOrdenes(ordenes){
            return new Promise((resolve, reject) => {
                sql = "SELECT id_orden, numero_orden, orden_qr, anulado, DATE_FORMAT(fecha, '%d-%m-%Y') AS fecha FROM `tbl_orden` WHERE fecha BETWEEN '" + req.body.from + "' AND '"+req.body.to+"'";
                connection.query(sql, function (err, result, fields) {
                    if (err) {
                        console.log('ERROR en CheckTemplate', err);
                        res.send('3');
    ...
    //const sql = "SELECT * FROM `tbl_orden` WHERE fecha = '2022-02-18'";
...
ordenesCtrl.ordenesTomaMuestra = async (req, res) => {
    ...
    async function extraerOrdenes(ordenes){
        return new Promise((resolve, reject) => {
            const sql = "SELECT id_orden, numero_orden, orden_qr, date_format(fecha, '%d-%m-%Y') AS fecha FROM `tbl_orden` WHERE check_toma_muestra = 0 AND check_sueros = 0 AND check_laboratorios = 0";
            connection.query(sql, function (err, result, fields) {
                if (err) {
                    console.log('ERROR en CheckTemplate', err);
                    res.send('3');
...
ordenesCtrl.ordenesSueros = async (req, res) => {
    ...
    async function extraerOrdenes(ordenes){
        return new Promise((resolve, reject) => {
            const sql = "SELECT id_orden, numero_orden, orden_qr, date_format(fecha, '%d-%m-%Y') AS fecha FROM `tbl_orden` WHERE check_toma_muestra = 1 AND check_sueros = 0 AND check_laboratorios = 0";
            connection.query(sql, function (err, result, fields) {
                if (err) {
                    console.log('ERROR en CheckTemplate', err);
                    res.send('3');
...
ordenesCtrl.ordenesLaboratorios = async (req, res) => {
    ...
    async function extraerOrdenes(ordenes){
        return new Promise((resolve, reject) => {
            const sql = "SELECT id_orden, numero_orden, orden_qr, date_format(fecha, '%d-%m-%Y') AS fecha FROM `tbl_orden` WHERE check_toma_muestra = 1 AND check_sueros = 1 AND check_laboratorios = 0";
            connection.query(sql, function (err, result, fields) {
                if (err) {
                    console.log('ERROR en CheckTemplate', err);
                    res.send('3');
...
ordenesCtrl.buscarOrden = async (req, res) => {
    ...
    const sql = "SELECT id_orden, numero_orden, orden_qr_nube, date_format(fecha,'%d-%m-%Y') AS fecha FROM `tbl_orden` WHERE id_orden='" + req.body.id_orden + "' OR orden_qr='" + req.body.orden_qr + "'";
    let idPaciente;
    console.log(sql)
    connection.query(sql, function (err, result, fields) {
        if (err) {
    ...
    async function detallesOrden(idOrden, numero_orden, fecha) {
        const sql = "SELECT id_detalle_factura_paciente, id_detalle_orden, id_usuario, id_usuario_modificado, comentario FROM `tbl_detalle_orden` WHERE id_orden='" + idOrden + "'";
        connection.query(sql, function (err, result, fields) {
            if (err) {
                //console.log('ERROR en CheckTemplate', err);
                res.send('3');
    ...
    async function examenesCultivos(idDetalleFacturaPaciente, i, maximo, cultivosExamenesId) {
        ...
        const sql = "SELECT id_examen, id_cultivo, id_paciente FROM `tbl_detalle_factura_paciente` WHERE id_detalle_factura_paciente='" + idDetalleFacturaPaciente[i].id_detalle_factura_paciente + "'";
        connection.query(sql, function (err, result, fields) {
            if (err) {
                //console.log('ERROR en CheckTemplate', err);
                res.send('3');
    ...
    async function buscarResultadoExamen(idDetalleExamenPrueba, idDetalleOrden, resultadoExamen) {
        return new Promise((resolve, reject) => {
            ...
            const sql = "SELECT resultado FROM tbl_resultado WHERE id_detalle_orden= '" + idDetalleOrden + "' AND id_detalle_examen_prueba ='" + idDetalleExamenPrueba + "'"
            connection.query(sql, function (err, result, fields) {
                if (err) {
                    console.log('ERROR en CheckTemplate', err);
                    res.send('3');
                ...
                if (result) {
                    if (result.length == 0 || result[0].resultado == 'null') {
                        ...
                        resultadoExamen = result[0].resultado
                    }
                    //console.log("XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX", idDetalleOrden, resultadoExamen)
    ...
    async function buscarResultadoCultivo(idDetalleCultivoBacteriaAntibiotico, idDetalleOrden, resultadoCultivo) {
        return new Promise((resolve, reject) => {
            const sql = "SELECT resultado FROM tbl_resultado WHERE id_detalle_orden= '" + idDetalleOrden + "' AND id_detalle_cultivo_bacteria_antibiotico ='" + idDetalleCultivoBacteriaAntibiotico + "'"
            connection.query(sql, function (err, result, fields) {
                if (err) {
                    console.log('ERROR en CheckTemplate', err);
                    res.send('3');
                ...
                if (result) {
                    if (result.length == 0 || result[0].resultado == 'null') {
                        ...
                        resultadoCultivo = result[0].resultado
                    }
