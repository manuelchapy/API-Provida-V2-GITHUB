     ...
     async function agruparRegistroConvenios(registrosConvenio) {
        return new Promise((resolve, reject) => {
            ...
            registrosConvenio.forEach(item => {
                ...
                if(!agrupados.hasOwnProperty(item.id_registro_convenio)){
